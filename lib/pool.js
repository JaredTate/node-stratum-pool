    ...
    function StartStratumServer(finishedCallback) {
        ...
        _this.stratumServer.on('started', function () {
            ...
            client.on('difficultyChanged', function (diff) {
                ...
                if (odoKey) {
                    emitLog('[ODO DEBUG] Sending job with OdoKey to ' + client.getLabel() + ': ' + odoKey.substring(0, 16) + '...');
                }
                this.sendMiningJob(_this.jobManager.currentJob.getJobParams(), odoKey);
        ...
        _this.daemon.cmd('getblocktemplate',
            ...
            function (result) {
                if (result.error) {
                    ...
                    // emitLog('GetBlockTemplate response:');
                    // emitLog(JSON.stringify(result.response, null, 2));
